...
/* cat.html.twig */
class __TwigTemplate_24a3bbedc6dfa627612428817c2946b52986dbb24df6e06984f74bbe0c953751 extends Twig_Template
{
    private $source;
...
\t\t\t\t\t\t<strong><a href=\"/";
            ...
            echo "/";
            echo twig_replace_filter(twig_trim_filter(twig_get_attribute($this->env, $this->source, $context["a"], "title", array())), array(" " => "-", "." => "", "/" => "", "+" => "", "," => ""));
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["a"], "title", array());
            echo " </a></strong>

\t\t\t\t\t\t";
            // line 18
            if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["a"], "text", array())) > 0)) {
                // line 19
                echo "\t\t\t\t\t\t<p>";
                echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["a"], "text", array())) > 500)) ? ((twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["a"], "text", array()), 0, 500) . "...")) : (twig_get_attribute($this->env, $this->source, $context["a"], "text", array())));
                echo " <a href=\"/";
                echo twig_get_attribute($this->env, $this->source, $context["a"], "id", array());
                echo "/";
                echo twig_replace_filter(twig_trim_filter(twig_get_attribute($this->env, $this->source, $context["a"], "title", array())), array(" " => "-", "." => "", "/" => "", "+" => "", "," => ""));
...
";
    ...
    {
        return array (  121 => 37,  111 => 33,  109 => 32,  105 => 30,  103 => 29,  100 => 28,  88 => 21,  78 => 19,  76 => 18,  67 => 16,  59 => 10,  55 => 9,  50 => 7,  47 => 6,  44 => 5,  33 => 3,  15 => 1,);
    }

    public function getSourceContext()
    {
        return new Twig_Source("", "cat.html.twig", "/home/dmytro/dev/php/toster/src/views/cat.html.twig");
    }
}
